...
import InactiveScriptModal from "../../components/Error-Modal/modal.component";
...
const Scripts = ({ script, comments }) => {
  ...
  const [noofuserscripts, setnoofuserscripts] = useState(0);
  ...
  return (
    <>
      {script.isActive === 0 && <InactiveScriptModal />}
          ...
          <div className={styles["scripts-left-content"]}>
            ...
            <div className={styles["top-content-div"]}>
              <div className={styles["view_title_div"]}>
                ...
                <h2 style={{ fontFamily: "Be Vietnam Pro" }}>{script.title}</h2>
              </div>
            ...
            <Tabs>
              ...
              <Panel title="Comments">
                <div
                  ...
                  ref={inputRef}
                >
                  <div className={styles["white-border"]}>
                    <Image
                      objectFit="cover"
                      layout="fill"
                      alt="loading"
