  ...
  return (
    <div className={styles["main2"]}>
      ...
      <div className={styles["formaddscript"]}>
        ...
        <form className={styles["row g-3"]}>
          <div className={styles["col-md-6"]}>
            <div className={styles["form-floating"]}>
              <input name="titles" value={titles} onChange={handleChange} type="text" className={styles["form-control"]} id="floatingInput1" placeholder="Enter Title" />
              <label>Script Title</label>
            </div>
          </div>
          <div className={styles["col-md-6"]}>
            <div className={styles["form-floating"]}>
              <input name="madeby" value={madeby} onChange={handleChange} type="text" className={styles["form-control"]} id="floatingInput2" placeholder="Enter Name" />
              <label>Made By</label>
            </div>
          </div>
          <div className={styles["col-md-6"]}>
            <div className={styles[""]}>
              ...
              <input className={styles["form-control"]} type="file" id="formFileMultiple" multiple />
            </div>
            <div className={styles["form-floating"]}>
              <textarea
                name="description"
          ...
          <div className={styles["col-md-6 align-content-around"]} style={{ marginTop: "0" }}>
            <div className={styles["form-floating"]}>
              <input
                name="gameLink"
                value={gameLink}
            ...
            <div className={styles["form-floating"]}>
              <input name="features" value={features} onChange={handleChange} type="text" className={styles["form-control"] + " " + styles["spc"]} id="floatingInput5" placeholder="Enter Features" />
              <label>Features</label>
            </div>
            <div className={styles["form-floating"]}>
              <input name="tags" value={tags} onChange={handleChange} type="text" className={styles["form-control"] + " " + styles["spc"]} id="floatingInput6" placeholder="Enter Tags" />
              <label>Tags</label>
            </div>
          </div>
          ...
          <div className={styles["form-buttons"]}>
            <div style={{ marginRight: "20px" }}>
              <button type="button" className={styles["btn"] + " " + styles["btn-1"]} id="liveToastBtn-success">
                Submit
              </button>
            </div>
            <div>
